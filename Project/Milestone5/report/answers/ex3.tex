...
works. One user suggested to use some kind of pop up message with explanation of the system works.
 ...
 \item One of the user issue was that he didn't know what to do after he finished shopping. He suggested that there should be a description saying, that user should scan the bardcode afterwards at the check-out
