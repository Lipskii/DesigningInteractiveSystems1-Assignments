...
\noindent\fbox{%
	\parbox{\textwidth}{%
		...
		\hspace{8em}	\includegraphics[clip, trim=0cm 5cm 0cm 0cm, scale=1.0]{../pics/1.png}
...
%			So, no need for a pointing device and a capture device capturing the pointing device's orientation nowadays, just image recognition to do the same functionality without the burden of two extra devices.
		...
		\hspace{8em}	\includegraphics[clip, trim=0cm 0cm 0cm 0cm, scale=1.0]{../pics/3.jpg}
...
\noindent\fbox{%
	\parbox{\textwidth}{%
		...
		\begin{compactitem}
			\item \textbf{Name of the current device or technology:} Alexa \\
			\textbf{Description:} YES (this feature does exist in current devices).
...
\noindent\fbox{%
	\parbox{\textwidth}{%
		...
		\begin{compactitem}
			\item \textbf{Name of the current device or technology:} \\
			\textbf{Description:}
		\end{compactitem}
