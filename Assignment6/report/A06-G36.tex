...
%		\label{fig:sub1}
	...
	\begin{subfigure}{.5\textwidth}
		\centering
		\includegraphics[clip, trim=0cm 0cm 0cm 0cm, scale=0.13]{./images/proximity.jpeg}
		\caption{Event Schedule}
%		\label{fig:sub2}
	\end{subfigure}
	\begin{subfigure}{.5\textwidth}
		\centering
		\includegraphics[clip, trim=0cm 0cm 0cm 0cm, scale=0.13]{./images/kominiarze-ulotka.jpeg}
